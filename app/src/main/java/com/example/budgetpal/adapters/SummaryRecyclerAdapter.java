...
public class SummaryRecyclerAdapter extends RecyclerView.Adapter<SummaryRecyclerAdapter.MyViewHolder>
{
    ...
    private ArrayList<BigDecimal> revenue_data, spendings_data;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            revenue_view=itemView.findViewById(R.id.summary_revenue);
            spending_view=itemView.findViewById(R.id.summary_spendings);
